...
public interface OsmData<O extends IPrimitive, N extends INode, W extends IWay<?, N>, R extends IRelation<?>> extends Data, Lockable {
     ...
     */
    Collection<O> allNonDeletedPrimitives();
     ...
     */
    Collection<O> allNonDeletedCompletePrimitives();
     ...
     * @see OsmPrimitive#isIncomplete
     */
    Collection<O> allNonDeletedPhysicalPrimitives();
     ...
     */
    Collection<O> allModifiedPrimitives();
     ...
     * @since 13309
     */
    Collection<O> allPreservedPrimitives();
     ...
     */
    boolean isSelected(IPrimitive osm);
